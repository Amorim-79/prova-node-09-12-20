...
var UsersController = /** @class */ (function () {
    function UsersController() {
        // Instância o service de usuário
    ...
    UsersController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersService.create(req.body)
                            .then(function (response) { return res.status(200).json({ data: response }); })
                            .catch(function (error) { return res.status(400).send({ error: error }); })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    */
    UsersController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersService.update(req.body, Number(req.params.id))
                            .then(function (response) { return res.status(200).json({ data: response }); })
                            .catch(function (error) { return res.status(404).send({ error: error }); })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    */
    UsersController.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersService.delete(Number(req.params.id))
                            .then(function (response) { return res.status(200).json({ data: response }); })
                            .catch(function (error) { return res.status(404).send({ error: error }); })];
                    case 1:
                        _a.sent();
